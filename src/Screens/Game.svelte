<script>
    ...
    $: score = results.filter((d) => d === "right").length;
...
<header>
    <p>tap on the more monetisable celebrity or tap "same price" </p>
</header>


<div class="game-container">
    {#if done}
        <div class="done" in:scale={{easing:elasticOut, duration: 600}}>
